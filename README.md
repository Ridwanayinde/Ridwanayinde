...
Experienced in building **data pipelines, dashboards, and analytical solutions** that support better decision-making.

- 🔍 Focused on transforming raw data into actionable insights for **Operations, Logistics, Energy, and Supply Chain** use cases.
- 🛠️ Hands-on experience building practical, end-to-end projects using **Python, SQL, Pandas, and SQLite**, with an emphasis
     on **real-world, open-source problems**.
